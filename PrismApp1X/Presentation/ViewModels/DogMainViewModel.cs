...
{
    public class DogMainViewModel : EventViewModelBase, IDogMainViewModel
    {
        ...
        public ObservableCollection<DogNavigationItemViewModel> Dogs { get; }
        ...
        DogNavigationItemViewModel _selectedDog;

        public DogNavigationItemViewModel SelectedDog
        {
