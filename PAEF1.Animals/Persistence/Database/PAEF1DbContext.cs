...
{
    public class PAEF1DbContext : DbContext, IPAEF1DbContext
    {
        // TODO(crhodes)
        ...
        public PAEF1DbContext() : base("PAEF1_DB")
        {
            ...
            // Database.SetInitializer<PAEF1DbContext>(new CreateDatabaseIfNotExists<PAEF1DbContext>());

            // 2. DropCreateDatabaseIfModelChanges

            // Database.SetInitializer<PAEF1DbContext>(new DropCreateDatabaseIfModelChanges<PAEF1DbContext>());

            Database.SetInitializer<PAEF1DbContext>(
                new DropCreateDatabaseIfModelChanges<PAEF1DbContext>());

            // 3. DropCreateDatabaseAlways

            // Database.SetInitializer<PAEF1DbContext>(new DropCreateDatabaseAlways<PAEF1DbContext>());

            // 4. Custom DB Initializer

            //Database.SetInitializer<PAEF1DbContext>(new PAEF1DbContextDatabaseInitializer());
