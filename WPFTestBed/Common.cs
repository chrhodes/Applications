...
namespace WPFTestBed
{
    public class Common
    {
        public const string APPLICATION_NAME = "WPFTestBed";
        public const string LOG_CATEGORY = "WPFTestBed";

        public const string cCONFIG_FILE = @"C:\temp\WPFTestBed_Config.xml";
