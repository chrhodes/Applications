...
namespace App3.Persistence.Data.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<App3DbContext>
    {
        ...
        void SeedInitialDatabaseTables(App3DbContext context)
        {
            Int64 startTicks = Log.PERSISTENCE("Enter", Common.LOG_APPNAME);
