...
namespace PAEF1a.Persistence.Data.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<PAEF1aDbContext>
    {
        ...
        void SeedInitialDatabaseTables(PAEF1aDbContext context)
        {
            Int64 startTicks = Log.PERSISTENCE("Enter", Common.LOG_CATEGORY);
