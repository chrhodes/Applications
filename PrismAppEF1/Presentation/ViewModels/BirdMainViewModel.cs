...
{
    public class BirdMainViewModel : EventViewModelBase, IBirdMainViewModel, IInstanceCountVM
    {

        #region Constructors, Initialization, and Load

        public BirdMainViewModel(
            IBirdNavigationViewModel BirdNavigationViewModel,
            Func<IBirdDetailViewModel> BirdDetailViewModelCreator,
            Func<ISongDetailViewModel> SongDetailViewModelCreator,
            ...
            IMessageDialogService messageDialogService) : base(eventAggregator, messageDialogService)
        {
            ...
            NavigationViewModel = BirdNavigationViewModel;
        ...
        public IBirdNavigationViewModel NavigationViewModel { get; }
            ...
            if (detailViewModel == null)
            {
                switch (args.ViewModelName)
                {
                    ...
                    case nameof(SongDetailViewModel):
                        detailViewModel = _SongDetailViewModelCreator();
                        break;
        ...
        {
            Int64 startTicks = Log.VIEWMODEL("BirdMainViewModel) Enter", Common.LOG_APPNAME);
