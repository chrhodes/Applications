...
namespace PrismAppEF1
{
    public partial class App : PrismApplication
    {
        ...
        protected override void ConfigureModuleCatalog(IModuleCatalog moduleCatalog)
        {
            ...
            moduleCatalog.AddModule(typeof(PrismAppEF1Module));
            ...
            System.Windows.Threading.DispatcherUnhandledExceptionEventArgs e)
        {
            Log.Error("Unexpected error occurred. Please inform the admin."
              + Environment.NewLine + e.Exception.Message + e.Exception.StackTrace, Common.LOG_APPNAME);

            MessageBox.Show("Unexpected error occurred. Please inform the admin."
              + Environment.NewLine + e.Exception.Message + e.Exception.StackTrace, "Unexpected error");
