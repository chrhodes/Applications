...
namespace TestPrismApp1
{
    public class Common
    {
        public const string PROJECT_NAME = "TestPrismApp1";
        public const string LOG_APPNAME = "TestPrismApp1";

        public const string cCONFIG_FILE = @"C:\temp\TestPrismApp1_Config.xml";
