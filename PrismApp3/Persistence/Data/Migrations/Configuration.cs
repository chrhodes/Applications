...
namespace PrismApp3.Persistence.Data.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<PrismApp3DbContext>
    {
        ...
        void SeedInitialDatabaseTables(PrismApp3DbContext context)
        {
            Int64 startTicks = Log.PERSISTENCE("Enter", Common.LOG_APPNAME);
