...
namespace PAI1.Persistence.Data.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<PAI1DbContext>
    {
        ...
        void SeedInitialDatabaseTables(PAI1DbContext context)
        {
            Int64 startTicks = Log.PERSISTENCE("Enter", Common.LOG_APPNAME);
