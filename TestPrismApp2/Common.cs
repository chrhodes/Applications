...
namespace TestPrismApp2
{
    public class Common
    {
        public const string PROJECT_NAME = "TestPrismApp2";
        public const string LOG_APPNAME = "TestPrismApp2";

        public const string cCONFIG_FILE = @"C:\temp\TestPrismApp2_Config.xml";
