...
namespace TestPrismApp2.Persistence.Data.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<TestPrismApp2DbContext>
    {
        ...
        void SeedInitialDatabaseTables(TestPrismApp2DbContext context)
        {
            Int64 startTicks = Log.Trace(String.Format("Enter"), Common.LOG_APPNAME);
