...
namespace PrismApp2
{
    public partial class App : PrismApplication
    {
        ...
        {
            Int64 startTicks = Log.APPLICATION_INITIALIZE(String.Format("Enter"), Common.LOG_APPNAME);

            Log.APPLICATION_INITIALIZE(String.Format("Exit"), Common.LOG_APPNAME, startTicks);
