...
namespace PrismAppEF5.Persistence.Data.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<PrismAppEF5DbContext>
    {
        ...
        void SeedInitialDatabaseTables(PrismAppEF5DbContext context)
        {
            Int64 startTicks = Log.PERSISTENCE("Enter", Common.LOG_APPNAME);
