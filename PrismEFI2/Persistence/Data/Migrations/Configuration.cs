...
namespace PrismEFI2.Persistence.Data.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<PrismEFI2DbContext>
    {
        ...
        void SeedInitialDatabaseTables(PrismEFI2DbContext context)
        {
            Int64 startTicks = Log.PERSISTENCE("Enter", Common.LOG_APPNAME);
